...
namespace Office365ADApp.Utils
{
    public class SettingsHelper
    {
        ...
        private static string _authorizationUri = "https://login.microsoftonline.com";
        private static string _authority = "https://login.microsoftonline.com/{0}/";
